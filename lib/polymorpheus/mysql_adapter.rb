module Polymorpheus
  module ConnectionAdapters
    module MysqlAdapter
      ...
      # uniqueness constraint, an on_delete action and an on_update action.
      #
      ...
      #
      #           the options of :on_delete and :on_update are directly passed
      #           to rails's add_foreign_key method, and more info on the
      #           accepted value and their effects can be found in rails
      #           documentation.
